...
module.exports.createCategory = async (req, res) => {
  ...
  try {
    const responseFromService = await categoryServices.createCategory(req.body);
    response.status = 200;
...
module.exports.getAllCategories = async (req, res) => {
  const response = { ...constaints.defaultServerResponse };
  try {
    const responseFromService = await categoryServices.getAllCategories(
      req.query
    );
    response.status = 200;
...
module.exports.getCategoryById = async (req, res) => {
  const response = { ...constaints.defaultServerResponse };
  try {
    const responseFromService = await categoryServices.getCategoryById(
      req.params
    );
    response.status = 200;
    response.message = constaints.categoryMessage.CATEGORY_FETCHED;
...
module.exports.deleteCategory = async (req, res) => {
  const response = { ...constaints.defaultServerResponse };
  try {
    const responseFromService = await categoryServices.deleteCategory(
      req.params
    );
    response.status = 200;
...
module.exports.updateCategory = async (req, res) => {
  const response = { ...constaints.defaultServerResponse };
  try {
    const responseFromService = await categoryServices.updateCategory({
      id: req.params.id,
      body: req.body,
    });
    response.status = 200;
