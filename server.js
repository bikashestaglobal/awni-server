...
app.use("/api/v1/natures", require("./routes/natureRoutes"));
app.use("/api/v1/surfaces", require("./routes/surfaceRoutes"));
app.use("/api/v1/shapes", require("./routes/shapeRoutes"));
app.use("/api/v1/series", require("./routes/seriesRoutes"));
app.use("/api/v1/patterns", require("./routes/patternRoutes"));
