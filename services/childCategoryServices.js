...
module.exports.createCategory = async (serviceData) => {
  try {
    ...
    console.log(
      `Something went Wrong services : chilsCategoryServices: createCategory`
    );
...
module.exports.getAllCategories = async ({
  ...
  try {
    ...
    if (searchQuery != "null") {
      query = `SELECT child_categories.id, child_categories.catalogue, child_categories.created_at, child_categories.status, child_categories.name, child_categories.image, child_categories.slug, par_categories.id as par_cat_id, par_categories.name as par_cat_name, par_categories.slug as par_cat_slug,  categories.id as cat_id, categories.name as cat_name, categories.slug as cat_slug FROM child_categories INNER JOIN par_categories ON par_categories.id = child_categories.par_cat_id INNER JOIN categories ON categories.id = child_categories.cat_id WHERE child_categories.name ILIKE '%${searchQuery}%' LIMIT ${parseInt(
        limit
      )} OFFSET ${parseInt(skip)}`;
    }
    ...
    if (par_cat_slug && par_cat_slug != undefined && par_cat_slug != null) {
      query = `SELECT child_categories.id, child_categories.catalogue, child_categories.created_at, child_categories.status, child_categories.name, child_categories.image, child_categories.slug, par_categories.id as par_cat_id, par_categories.name as par_cat_name, par_categories.slug as par_cat_slug,  categories.id as cat_id, categories.name as cat_name, categories.slug as cat_slug FROM child_categories INNER JOIN par_categories ON par_categories.id = child_categories.par_cat_id INNER JOIN categories ON categories.id = child_categories.cat_id WHERE par_categories.slug=${par_cat_slug} LIMIT ${parseInt(
        limit
      )} OFFSET ${parseInt(skip)}`;
    }
    ...
    if (cat_slug && cat_slug != undefined && cat_slug != null) {
      query = `SELECT child_categories.id, child_categories.catalogue, child_categories.created_at, child_categories.status, child_categories.name, child_categories.image, child_categories.slug, par_categories.id as par_cat_id, par_categories.name as par_cat_name, par_categories.slug as par_cat_slug,  categories.id as cat_id, categories.name as cat_name, categories.slug as cat_slug FROM child_categories INNER JOIN par_categories ON par_categories.id = child_categories.par_cat_id INNER JOIN categories ON categories.id = child_categories.cat_id WHERE categories.slug=${cat_slug} LIMIT ${parseInt(
        limit
      )} OFFSET ${parseInt(skip)}`;
    }
    ...
    console.log(
      `Something went Wrong services : chilsCategoryServices: getAllCategories`
    );
...
module.exports.getCategoryWithProducts = async ({
  ...
  try {
    ...
    console.log(
      `Something went Wrong services : chilsCategoryServices: getCategoryWithProducts`
    );
    throw new Error(error.message);
  }
};
...
module.exports.getCategoryById = async ({ id }) => {
  try {
    ...
    const query = `SELECT child_categories.id, child_categories.catalogue, child_categories.created_at, child_categories.status, child_categories.name, child_categories.image, child_categories.slug, par_categories.id as par_cat_id, par_categories.name as par_cat_name, categories.id as cat_id, categories.name as cat_name FROM child_categories INNER JOIN par_categories ON par_categories.id = child_categories.par_cat_id INNER JOIN categories ON categories.id = child_categories.cat_id WHERE child_categories.id = ${id}`;
    ...
    console.log(
      `Something went Wrong services : chilsCategoryServices: getCategoryById`
    );
    throw new Error(error.message);
  }
};
...
module.exports.deleteCategory = async ({ id }) => {
  try {
    const query = `DELETE FROM child_categories WHERE id = ${id} RETURNING *`;
    ...
    console.log(
      `Something went Wrong services : chilsCategoryServices: deleteCategory`
    );
    throw new Error(error.message);
  }
};
...
module.exports.updateCategory = async ({ id, body }) => {
  try {
    ...
    console.log(
      `Something went Wrong services : chilsCategoryServices: updateCategory`
    );
    throw new Error(error);
  }
};
